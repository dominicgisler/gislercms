...
VALUES (1, 'Startseite/Home', 1, 1),
       (2, 'Error 404', 0, 1),
       (3, 'Impressum/Imprint', 1, 1),
       (4, 'Datenschutzerklärung/Privacy policy', 1, 1),
       (5, 'Galerie/Gallery', 1, 1),
       (6, 'Gästebuch/Guestbook', 1, 1);
...
<p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis.</p>', 1),
       (2, 1, 2, 'home', 'Home', '<h1>Welcome to your Website!</h1><p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>
<p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
<p>Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.</p>
<p>Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
<p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis.</p>', 1),
...
<p>Dieses Impressum basiert auf einer Vorlage von <a href="https://www.swissanwalt.ch" target="_blank" rel="noopener">SwissAnwalt</a>.</p>', 1),
...
<h4>Kommentare</h4>
<p>Wenn Sie auf unserer Webseite Kommentare abgeben werden neben dem reinen Text auch Angaben zum Zeitpunkt der Erstellung sowie ihr Nutzername gespeichert. Auf diese Art garantieren wir die Sicherheit unseres Blog, rechtswidrige Beitr&auml;ge von Benutzern k&ouml;nnen nachverfolgt werden.</p>
...
<p>Ihre pers&ouml;nlichen Daten werden nur so lange gespeichert, wie dies absolut notwendig ist um die angegebenen Dienste zu leisten und es vom Gesetz vorgeschrieben ist. Nach Ablauf dieser Fristen werden die pers&ouml;nlichen Daten der Nutzer regelm&auml;ssig gel&ouml;scht.</p>
...
<p>Unsere Datenschutzerkl&auml;rung kann in unregelm&auml;ssigen Abst&auml;nden angepasst werden, damit sie den aktuellen rechtlichen Anforderungen entspricht oder um &Auml;nderungen unserer Dienstleistungen umzusetzen, z. B. bei der Einf&uuml;gung neuer Angebote. F&uuml;r Ihren n&auml;chsten Besuch gilt dann automatisch die neue Datenschutzerkl&auml;rung.</p>
<h4>Kontakt</h4>
<p>F&uuml;r Fragen zum Datenschutz senden Sie uns bitte eine Nachricht an info@example.com mit dem Betreff "Datenschutz".</p>
<p>Diese Datenschutzerkl&auml;rung basiert auf einer Vorlage von <a href="https://xn--datenschutzerklrunggenerator-knc.de/" target="_blank" rel="noopener">datenschutzerkl&auml;runggenerator.de</a>.</p>', 1),
       (7, 5, 1, 'galerie', 'Galerie', '<pre class="module">gallery-de</pre>', 1),
       (8, 5, 2, 'gallery', 'Gallery', '<pre class="module">gallery-en</pre>', 1),
       (9, 6, 1, 'gaestebuch', 'Gästebuch', '<pre class="module">guestbook-de</pre>', 1),
       (10, 6, 2, 'guestbook', 'Guestbook', '<pre class="module">guestbook-en</pre>', 1);